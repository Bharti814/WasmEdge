...
private:
  ...
  Expect<AST::CompositeType> loadCompositeType(TypeCode TC, ASTNodeAttr From);
  Expect<AST::DefinedType> loadSubType(TypeCode TC, ASTNodeAttr From);
  Expect<AST::RecursiveType> loadRecursiveType(ASTNodeAttr From);
